...
const ContactUs = () => (
  <div className="pt-20 bg-gradient-to-r from-cyan-600 to-indigo-600">
      ...
      <div className="grid grid-cols-1 mx-auto max-w-7xl lg:grid-cols-2">
        <div className="relative px-6 pt-24 pb-20 sm:pt-32 lg:static lg:px-8 lg:py-48">
          <div className="max-w-xl mx-auto lg:mx-0 lg:max-w-lg">
            ...
            <h2 className="text-3xl font-bold tracking-tight">We Would Love to Hear from You</h2>
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Contact Number to join, get any information or to volunteer
              in the virtuous campaign of all free services.
            </p>
            <dl className="mt-10 space-y-4 text-base leading-7 text-gray-600">
              <div className="flex gap-x-4">
                ...
                <dd>
                  Dashrath Sevashram, 54-55, Chanakyapuri, Opposite to garden
                  , Annapurna Road, Indore – 452009, Madhya Pradesh
                </dd>
              </div>
              <div className="flex gap-x-4">
                <dt className="flex-none">
                ...
                <dd className="flex gap-x-2">
                  <a href="tel:+91 98261-94411">+91 98261-94411</a>
                  <a href="tel:+91 98261-95511">+91 98261-95511</a>
                </dd>
              </div>
              <div className="flex gap-x-4">
                <dt className="flex-none">
                ...
                <dd>
                  <a className="hover" href="mailto:goldcoinseva@gmail.com">
                    goldcoinseva@gmail.com
                  </a>
                </dd>
              </div>
            </dl>
